...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        .login-button {
            ...
            margin-top: 10px;
            display: block;
            /* Agar tombol mengambil lebar penuh, jika diperlukan */
            margin-left: auto;
            margin-right: auto;
        }
...
<body>
    ...
    <div class="info-bar bg-black">
        <marquee>
            <span class="version">SIMPKB 6.9 - 24062020 |
                <?php date_default_timezone_set('Asia/Jakarta');
                setlocale(LC_TIME, 'id_ID', 'id_ID.utf8', 'id_ID.UTF-8', 'ind');
                $tanggal_indonesia = strftime('%A , %e %B %Y | %H : %M WIB');
                echo $tanggal_indonesia; ?></span>
